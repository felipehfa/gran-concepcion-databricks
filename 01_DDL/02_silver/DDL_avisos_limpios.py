...
# MAGIC (`04_limpieza_plata_sql.py`, sección 1.5) y
# MAGIC `superficie_util_imputada`/`superficie_total_imputada`/
# MAGIC `fecha_imputacion_util`/`fecha_imputacion_total`
...
spark.sql("""
    CREATE TABLE IF NOT EXISTS gran_concepcion.02_plata.avisos_limpios (
        id_aviso                                    STRING,
        comuna                                       STRING,
